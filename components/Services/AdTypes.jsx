                ...
                <div class="container px-5 py-24 mx-auto flex flex-wrap">
                    {
                        AdsProcess.map((val,ind)=>(
                            <div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
                                ...
                                <div class="bg-green-600 flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center  text-white relative z-10 title-font font-medium text-sm">{ind+91}</div>
